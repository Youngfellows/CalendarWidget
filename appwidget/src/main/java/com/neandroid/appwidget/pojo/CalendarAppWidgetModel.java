...
import com.neandroid.appwidget.widget.CalendarAppWidgetService;
...
public class CalendarAppWidgetModel {
    ...
    public void buildFromCursor(Cursor cursor, String timeZone) {
        ...
        while (cursor.moveToNext()) {
            ...
            if (LOGD) {
                Log.d(TAG, j + " ,Row #" + rowId + " ,allDay:" + allDay + " ,start:" + start + " ,end:" + end + " ,eventId:" + eventId + " ,mNow:" + mNow);
                Log.d(TAG, j + " ,startDay: " + startDay + " ,endDay:" + endDay + " ,color:" + color + " ,selfStatus:" + selfStatus);
                Log.d(TAG, j + " ,title: " + title + " ,location:" + location + ",(mNow-end):" + (mNow - end));
            }
            j++;
