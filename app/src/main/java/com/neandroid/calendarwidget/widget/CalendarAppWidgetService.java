...
package com.neandroid.calendarwidget.widget;
...
import com.neandroid.calendarwidget.R;
import com.neandroid.calendarwidget.utils.Utils;

import java.util.concurrent.ExecutorService;
import java.util.concurrent.Executors;
import java.util.concurrent.atomic.AtomicInteger;

import com.neandroid.calendarwidget.widget.CalendarAppWidgetModel.*;

public class CalendarAppWidgetService extends RemoteViewsService {
    public static final String TAG = "CalendarAppWidgetService";
    ...
    public static class CalendarFactory extends BroadcastReceiver implements
        ...
        public void onCreate() {
            Log.d(TAG, Log.getStackTraceString(new IllegalArgumentException("onCreate ... ^_^ ...")));
        ...
        public void onLoadComplete(Loader<Cursor> loader, Cursor cursor) {
            Log.w(TAG, Log.getStackTraceString(new IllegalArgumentException("onLoadComplete ...")));
